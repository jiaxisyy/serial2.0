...
public class TestActivity extends Activity implements View.OnClickListener, View.OnLongClickListener {
        ...
        public void handleMessage(android.os.Message msg) {
            switch(msg.what){
                case 1:
                    ...
                    break;
                case 2 :
                    test_tv_vw_read_input.setText(msg.obj.toString());
                    break;
                case 3 :
                    test_tv_vd_read_input.setText(msg.obj.toString());
                    break;
                case 4 :
                    test_tv_f_read_input.setText(msg.obj.toString());
                    break;
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.test_btn_m_write:
                if(test_et_m_write_address.getText().toString()!=null &&
                        !test_et_m_write_address.getText().toString().equals("")
                        &&test_et_m_write_input.getText().toString()!=null &&
                        !test_et_m_write_input.getText().toString().equals("") &&
                        test_et_m_write_input.getText().toString()!=null &&
                        !test_et_m_write_input.getText().toString().equals("")) {
            ...
            case R.id.test_btn_m_read:
                if(test_et_m_read_address.getText().toString()!=null &&
                        !test_et_m_read_address.getText().toString().equals("")
                        &&test_et_m_read_type.getText().toString()!=null &&
                        !test_et_m_read_type.getText().toString().equals("")) {
            ...
            case R.id.test_btn_vw_write:
                if(test_et_vw_write_address.getText().toString()!=null &&
                        !test_et_vw_write_address.getText().toString().equals("")
                        &&test_et_vw_write_type.getText().toString()!=null &&
                        !test_et_vw_write_type.getText().toString().equals("") &&
                        test_et_vw_write_input.getText().toString()!=null &&
                        !test_et_vw_write_input.getText().toString().equals("")) {
            ...
            case R.id.test_btn_vw_read:
                if(test_et_vw_read_address.getText().toString()!=null &&
                        !test_et_vw_read_address.getText().toString().equals("")
                        &&test_et_vw_read_type.getText().toString()!=null &&
                        !test_et_vw_read_type.getText().toString().equals("")) {
            ...
            case R.id.test_btn_vd_write:
                if(test_et_vd_write_address.getText().toString()!=null &&
                        !test_et_vd_write_address.getText().toString().equals("")
                        &&test_et_vd_write_type.getText().toString()!=null &&
                        !test_et_vd_write_type.getText().toString().equals("") &&
                        test_et_vd_write_input.getText().toString()!=null &&
                        !test_et_vd_write_input.getText().toString().equals("")) {
            ...
            case R.id.test_btn_vd_read:
                if(test_et_vd_read_address.getText().toString()!=null &&
                        !test_et_vd_read_address.getText().toString().equals("")
                        &&test_et_vd_read_type.getText().toString()!=null &&
                        !test_et_vd_read_type.getText().toString().equals("") ) {
            ...
            case R.id.test_btn_f_write:
                if(test_et_f_write_address.getText().toString()!=null &&
                        !test_et_f_write_address.getText().toString().equals("")
                        &&test_et_f_write_type.getText().toString()!=null &&
                        !test_et_f_write_type.getText().toString().equals("") &&
                        test_et_f_write_input.getText().toString()!=null &&
                        !test_et_f_write_input.getText().toString().equals("")) {
            ...
            case R.id.test_btn_f_read:
                if(test_et_f_read_address.getText().toString()!=null &&
                        !test_et_f_read_address.getText().toString().equals("")
                        &&test_et_f_read_type.getText().toString()!=null &&
                        !test_et_f_read_type.getText().toString().equals("")) {
    ...
    public boolean onLongClick(View v) {
        switch (v.getId()){
            case R.id.test_btn_m_write:
                if(test_btn_m_write.getText().toString().equals("写入")){
                    test_btn_m_write.setText("停止");
                    if(test_et_m_write_address.getText().toString()!=null &&
                            !test_et_m_write_address.getText().toString().equals("")
                            &&test_et_m_write_input.getText().toString()!=null &&
                            !test_et_m_write_input.getText().toString().equals("") &&
                    ...
                    test_btn_m_write.setText("写入");
                    flag_m_write=false;
                }

                break;
            case R.id.test_btn_m_read:
                if(test_btn_m_read.getText().toString().equals("读出")){
                    test_btn_m_read.setText("停止");
                    if(test_et_m_read_address.getText().toString()!=null &&
                            !test_et_m_read_address.getText().toString().equals("")
                            &&test_et_m_read_type.getText().toString()!=null &&
                            !test_et_m_read_type.getText().toString().equals("")) {
                    ...
                    test_btn_m_read.setText("读出");
                    flag_m_read=false;
                }
                break;
            case R.id.test_btn_vw_write:
                if(test_btn_vw_write.getText().toString().equals("写入")){
                    test_btn_vw_write.setText("停止");
                    if(test_et_vw_write_address.getText().toString()!=null &&
                            !test_et_vw_write_address.getText().toString().equals("")
                            &&test_et_vw_write_type.getText().toString()!=null &&
                            !test_et_vw_write_type.getText().toString().equals("") &&
                    ...
                    test_btn_vw_write.setText("写入");
                    flag_vw_write=false;
                }
                break;
            case R.id.test_btn_vw_read:

                if(test_btn_vw_read.getText().toString().equals("读出")){
                    test_btn_vw_read.setText("停止");
                    if(test_et_vw_read_address.getText().toString()!=null &&
                            !test_et_vw_read_address.getText().toString().equals("")
                            &&test_et_vw_read_type.getText().toString()!=null &&
                            !test_et_vw_read_type.getText().toString().equals("")) {
                    ...
                    test_btn_vw_read.setText("读出");
                    flag_vw_read=false;
                }
                break;
            case R.id.test_btn_vd_write:
                if(test_btn_vd_write.getText().toString().equals("写入")){
                    test_btn_vd_write.setText("停止");
                    if(test_et_vd_write_address.getText().toString()!=null &&
                            !test_et_vd_write_address.getText().toString().equals("")
                            &&test_et_vd_write_type.getText().toString()!=null &&
                            !test_et_vd_write_type.getText().toString().equals("") &&
                    ...
                    test_btn_vd_write.setText("读出");
                    flag_vd_write=false;
                }
                break;
            case R.id.test_btn_vd_read:
                if(test_btn_vd_read.getText().toString().equals("读出")){
                    test_btn_vd_read.setText("停止");
                    if(test_et_vd_read_address.getText().toString()!=null &&
                            !test_et_vd_read_address.getText().toString().equals("")
                            &&test_et_vd_read_type.getText().toString()!=null &&
                            !test_et_vd_read_type.getText().toString().equals("") ) {
                    ...
                    test_btn_vd_read.setText("读出");
                    flag_vd_read=false;
                }
                break;
            case R.id.test_btn_f_write:
                if(test_btn_f_write.getText().toString().equals("写入")){
                    test_btn_f_write.setText("停止");
                    if(test_et_f_write_address.getText().toString()!=null &&
                            !test_et_f_write_address.getText().toString().equals("")
                            &&test_et_f_write_type.getText().toString()!=null &&
                            !test_et_f_write_type.getText().toString().equals("") &&
                    ...
                    test_btn_f_write.setText("读出");
                    flag_f_write=false;
                }
                break;
            case R.id.test_btn_f_read:
                if(test_btn_f_read.getText().toString().equals("读出")){
                    test_btn_f_read.setText("停止");
                    if(test_et_f_read_address.getText().toString()!=null &&
                            !test_et_f_read_address.getText().toString().equals("")
                            &&test_et_f_read_type.getText().toString()!=null &&
                            !test_et_f_read_type.getText().toString().equals("")) {
